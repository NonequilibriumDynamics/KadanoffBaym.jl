...
@inline reverse2(t::Tuple) = _reverse2(t...)
@inline _reverse2() = throw(ArgumentError("Cannot call reverse2 on an empty tuple."))
@inline _reverse2(t) = throw(ArgumentError("Cannot call reverse2 on a 1-element tuple."))
@inline _reverse2(t1,t2,t...) = (t2, t1, t...)
...
@inline _front2_last(v1,v2, rest...) = ((v1,v2), rest...)
...
@inline _front_last2(v1,v2) = ((), (v1, v2))
@inline _front_last2(v, t...) = tuplejoin((v,), _front_last2(t...)...)
